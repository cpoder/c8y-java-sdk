...
public interface ApplicationVersionsApi extends ApiClient.Api {
    ...
    ApiResponse<ApplicationVersionCollection> getApplicationVersionCollectionResourceWithHttpInfo(
            @Param("id") String id,
            @Param("accept") String accept);
    ...
    ApiResponse<ApplicationVersion> putApplicationVersionResourceWithHttpInfo(@Param("id") String id,
            @Param("version") String version, ApplicationVersionTag applicationVersionTag,
            @Param("accept") String accept);
