...
public interface ApplicationsApi extends ApiClient.Api {
  ...
  ApplicationCollection getAbstractApplicationCollectionResource(@Param("currentPage") Integer currentPage,
      ...
      @Param("providedFor") String providedFor, @Param("subscriber") String subscriber, @Param("tenant") String tenant,
  ...
  Application postApplicationCollectionResource(
      PostApplicationCollectionResourceRequest postApplicationCollectionResourceRequest, @Param("accept") String accept,
      @Param("xCumulocityProcessingMode") String xCumulocityProcessingMode);
  ...
  ApiResponse<Application> postApplicationResourceWithHttpInfo(@Param("id") String id, @Param("version") String version,
      @Param("tag") String tag, @Param("accept") String accept,
      @Param("xCumulocityProcessingMode") String xCumulocityProcessingMode);
